...
<form action="/admin/kategori/{{$kategori->slug_kategori}}" method="POST">
    @method('PUT')
    @csrf
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control @error('slug_kategori') is-invalid @enderror" id="slug_kategori" name="slug_kategori" autofocus value="{{ old ('slug_kategori',$kategori->slug_kategori)}}">
        @error('slug_kategori')
        <div class="invalid-feedback">
          {{ $message}}
        </div>
